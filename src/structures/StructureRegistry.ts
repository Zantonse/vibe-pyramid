  ...
  const registry: Structure[] = [
    {
      ...
      name: 'Obelisk',
      icon: '\u{1F5FC}',
      worldOffset: new THREE.Vector3(12, 0, -8),
      slots: generateObeliskSlots(new THREE.Vector3(12, 0, -8)),
    },
    {
      id: 'sphinx',
      name: 'Sphinx',
      icon: '\u{1F981}',
      worldOffset: new THREE.Vector3(30, 0, 0),
      slots: generateSphinxSlots(new THREE.Vector3(30, 0, 0)),
    },
    {
      id: 'colonnade',
      name: 'Colonnade',
      icon: '\u{1F6E4}',
      worldOffset: new THREE.Vector3(-12, 0, -8),
      slots: generateColonnadeSlots(new THREE.Vector3(-12, 0, -8)),
    },
    {
      id: 'small-pyramid',
      name: 'Queen\'s Pyramid',
      icon: '\u{1F53A}',
      worldOffset: new THREE.Vector3(-20, 0, -15),
      slots: generateSmallPyramidSlots(new THREE.Vector3(-20, 0, -15)),
    },
    {
      id: 'boat',
      name: 'Solar Barque',
      icon: '\u{26F5}',
      worldOffset: new THREE.Vector3(18, 0, 10),
      slots: generateBoatSlots(new THREE.Vector3(18, 0, 10)),
    },
    {
      id: 'step-pyramid',
      name: 'Step Pyramid of Djoser',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(-30, 0, 10),
      slots: generateStepPyramidSlots(new THREE.Vector3(-30, 0, 10)),
    },
    {
      id: 'temple',
      ...
      slots: generateTempleSlots(new THREE.Vector3(0, 0, 18)),
    },
    {
      id: 'mastaba',
      name: 'Mastaba Tomb',
      icon: '\u{1F3DA}',
      worldOffset: new THREE.Vector3(-25, 0, -8),
      slots: generateMastabaSlots(new THREE.Vector3(-25, 0, -8)),
    },
    {
      id: 'pylon-gate',
      name: 'Pylon Gate',
      ...
      slots: generatePylonGateSlots(new THREE.Vector3(0, 0, -25)),
    },
    {
      id: 'hypostyle-hall',
      name: 'Hypostyle Hall',
