...
export function getStructureRegistry(): Structure[] {
  const registry: Structure[] = [
    ...
    },
    {
      ...
      name: 'Royal Granary',
      icon: '\u{1F33E}',
      worldOffset: new THREE.Vector3(55, 0, -42),
      slots: generateGranarySlots(new THREE.Vector3(55, 0, -42)),
    },
    {
      id: 'altar',
    ...
    },
    {
      ...
      icon: '\u{26CF}',
      worldOffset: new THREE.Vector3(80, 0, -38),
      slots: generateGreatQuarrySlots(new THREE.Vector3(80, 0, -38)),
    },
    {
      id: 'irrigation-canal',
      name: 'Irrigation Canal',
      icon: '\u{1F6BF}',
      worldOffset: new THREE.Vector3(25, 0, -35),
      slots: generateIrrigationCanalSlots(new THREE.Vector3(25, 0, -35)),
    },
    {
      id: 'cliff-temple',
      name: 'Cliff Temple',
    ...
    },
    {
      ...
      name: 'Marketplace',
      icon: '\u{1F3EA}',
      worldOffset: new THREE.Vector3(65, 0, -32),
      slots: generateMarketplaceSlots(new THREE.Vector3(65, 0, -32)),
    },
    {
    ...
    },
    {
      ...
      name: 'Stone Wharf',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(35, 0, -38),
      slots: generateStoneWharfSlots(new THREE.Vector3(35, 0, -38)),
    },
    {
      id: 'temple-of-hathor',
    ...
    },
    {
      ...
      slots: generateNileHarborSlots(new THREE.Vector3(50, 0, -35)),
    },
    {
