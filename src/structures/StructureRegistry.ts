...
export function getStructureRegistry(): Structure[] {
  const registry: Structure[] = [
    ...
    },
    {
      ...
      name: 'Royal Granary',
      icon: '\u{1F33E}',
      worldOffset: new THREE.Vector3(55, 0, -67),
      slots: generateGranarySlots(new THREE.Vector3(55, 0, -67)),
    },
    {
      id: 'altar',
    ...
    },
    {
      ...
      icon: '\u{26CF}',
      worldOffset: new THREE.Vector3(80, 0, -63),
      slots: generateGreatQuarrySlots(new THREE.Vector3(80, 0, -63)),
    },
    {
      id: 'irrigation-canal',
      name: 'Irrigation Canal',
      icon: '\u{1F6BF}',
      worldOffset: new THREE.Vector3(25, 0, -60),
      slots: generateIrrigationCanalSlots(new THREE.Vector3(25, 0, -60)),
    },
    {
      id: 'cliff-temple',
      name: 'Cliff Temple',
    ...
    },
    {
      ...
      name: 'Marketplace',
      icon: '\u{1F3EA}',
      worldOffset: new THREE.Vector3(65, 0, -58),
      slots: generateMarketplaceSlots(new THREE.Vector3(65, 0, -58)),
    },
    {
    ...
    },
    {
      ...
      name: 'Stone Wharf',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(35, 0, -63),
      slots: generateStoneWharfSlots(new THREE.Vector3(35, 0, -63)),
    },
    {
      id: 'temple-of-hathor',
    ...
    },
    {
      ...
      name: 'Grand Harbor',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(50, 0, -60),
      slots: generateNileHarborSlots(new THREE.Vector3(50, 0, -60)),
    },
    {
