...
export function getStructureRegistry(): Structure[] {
  const registry: Structure[] = [
    ...
    },
    {
      ...
      icon: '\u{1F53A}',
      worldOffset: new THREE.Vector3(-30, 0, -25),
      slots: generateSmallPyramidSlots(new THREE.Vector3(-30, 0, -25)),
    },
    {
      id: 'boat',
      name: 'Solar Barque',
    ...
    },
    {
      ...
      name: 'Mastaba Tomb',
      icon: '\u{1F3DA}',
      worldOffset: new THREE.Vector3(-32, 0, -15),
      slots: generateMastabaSlots(new THREE.Vector3(-32, 0, -15)),
    },
    {
      id: 'pylon-gate',
      name: 'Pylon Gate',
    ...
    },
    {
      ...
      name: 'Hypostyle Hall',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(65, 0, 15),
      slots: generateHypostyleHallSlots(new THREE.Vector3(65, 0, 15)),
    },
    {
      id: 'sacred-lake',
      name: 'Sacred Lake',
      icon: '\u{1F30A}',
      worldOffset: new THREE.Vector3(-30, 0, 48),
      slots: generateSacredLakeSlots(new THREE.Vector3(-30, 0, 48)),
    },
    {
      id: 'worker-hovels',
      name: 'Worker Hovels',
      icon: '\u{1F3DA}',
      worldOffset: new THREE.Vector3(112, 0, 48),
      slots: generateWorkerHovelSlots(new THREE.Vector3(112, 0, 48)),
    },
    {
      id: 'royal-granary',
      name: 'Royal Granary',
      icon: '\u{1F33E}',
      worldOffset: new THREE.Vector3(55, 0, -172),
      slots: generateGranarySlots(new THREE.Vector3(55, 0, -172)),
    },
    {
      id: 'altar',
      name: 'Altar of Offerings',
      icon: '\u{1F525}',
      worldOffset: new THREE.Vector3(25, 0, 55),
      slots: generateAltarSlots(new THREE.Vector3(25, 0, 55)),
    },
    {
      id: 'valley-temple',
      name: 'Valley Temple',
      icon: '\u{26E9}',
      worldOffset: new THREE.Vector3(0, 0, -60),
      slots: generateValleyTempleSlots(new THREE.Vector3(0, 0, -60)),
    },
    {
      id: 'small-market',
      name: 'Small Market',
      icon: '\u{1F3EA}',
      worldOffset: new THREE.Vector3(72, 0, 42),
      slots: generateSmallMarketSlots(new THREE.Vector3(72, 0, 42)),
    },
    {
      id: 'shrine-of-anubis',
      name: 'Shrine of Anubis',
      icon: '\u{1F43A}',
      worldOffset: new THREE.Vector3(-62, 0, -40),
      slots: generateShrineOfAnubisSlots(new THREE.Vector3(-62, 0, -40)),
    },
    {
      id: 'craftsmen-quarter',
      name: 'Craftsmen Quarter',
      icon: '\u{1F528}',
      worldOffset: new THREE.Vector3(70, 0, 42),
      slots: generateCraftsmenQuarterSlots(new THREE.Vector3(70, 0, 42)),
    },
    {
      id: 'colossi',
    ...
    },
    {
      ...
      icon: '\u{1F451}',
      worldOffset: new THREE.Vector3(75, 0, 60),
      slots: generatePharaohPalaceSlots(new THREE.Vector3(75, 0, 60)),
    },
    {
      id: 'mud-tenements',
      name: 'Mud Brick Tenements',
      icon: '\u{1F3E0}',
      worldOffset: new THREE.Vector3(118, 0, 55),
      slots: generateMudTenementSlots(new THREE.Vector3(118, 0, 55)),
    },
    {
      id: 'grand-bazaar',
      name: 'Grand Bazaar',
      icon: '\u{1F3AA}',
      worldOffset: new THREE.Vector3(82, 0, 48),
      slots: generateGrandBazaarSlots(new THREE.Vector3(82, 0, 48)),
    },
    {
      id: 'noble-villa',
      name: 'Noble Villa',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(105, 0, 58),
      slots: generateNobleVillaSlots(new THREE.Vector3(105, 0, 58)),
    },
    {
      id: 'government-hall',
      name: 'Government Hall',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(88, 0, 55),
      slots: generateGovernmentHallSlots(new THREE.Vector3(88, 0, 55)),
    },
    {
      id: 'royal-treasury',
      name: 'Royal Treasury',
      icon: '\u{1F48E}',
      worldOffset: new THREE.Vector3(95, 0, 52),
      slots: generateRoyalTreasurySlots(new THREE.Vector3(95, 0, 52)),
    },
    {
      id: 'great-quarry',
    ...
    },
    {
      ...
      icon: '\u{1F6BF}',
      worldOffset: new THREE.Vector3(25, 0, -165),
      slots: generateIrrigationCanalSlots(new THREE.Vector3(25, 0, -165)),
    },
    {
      id: 'cliff-temple',
      name: 'Cliff Temple',
    ...
    },
    {
      ...
      icon: '\u{1F5FC}',
      worldOffset: new THREE.Vector3(65, 0, 60),
      slots: generateLighthouseSlots(new THREE.Vector3(65, 0, 60)),
    },
    {
      id: 'eternal-city',
      name: 'Eternal City',
      icon: '\u{1F451}',
      worldOffset: new THREE.Vector3(0, 0, -140),
      slots: generateEternalCitySlots(new THREE.Vector3(0, 0, -140)),
    },
    {
      id: 'abu-simbel',
      ...
      slots: generateAbuSimbelSlots(new THREE.Vector3(0, 0, -85)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F4DC}',
      worldOffset: new THREE.Vector3(98, 0, 42),
      slots: generateScribesAcademySlots(new THREE.Vector3(98, 0, 42)),
    },
    {
      id: 'nilometer',
      name: 'Nilometer',
      icon: '\u{1F4CF}',
      worldOffset: new THREE.Vector3(25, 0, 65),
      slots: generateNilometerSlots(new THREE.Vector3(25, 0, 65)),
    },
    {
      id: 'chariot-stable',
      name: 'Chariot Stable',
      icon: '\u{1F6F4}',
      worldOffset: new THREE.Vector3(100, 0, 40),
      slots: generateChariotStableSlots(new THREE.Vector3(100, 0, 40)),
    },
    {
      id: 'brewery-bakery',
      name: 'Brewery & Bakery',
      icon: '\u{1F37A}',
      worldOffset: new THREE.Vector3(78, 0, 32),
      slots: generateBreweryBakerySlots(new THREE.Vector3(78, 0, 32)),
    },
    {
      id: 'military-garrison',
      name: 'Military Garrison',
      icon: '\u{1F6E1}',
      worldOffset: new THREE.Vector3(108, 0, 42),
      slots: generateGuardBarracksSlots(new THREE.Vector3(108, 0, 42)),
    },
    {
      id: 'sphinx-avenue-gate',
      name: 'Sphinx Avenue Gate',
      icon: '\u{1F6AA}',
      worldOffset: new THREE.Vector3(0, 0, -35),
      slots: generateSphinxAvenueGateSlots(new THREE.Vector3(0, 0, -35)),
    },
    {
      id: 'sed-festival-pavilion',
      name: 'Sed Festival Pavilion',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(-35, 0, 55),
      slots: generateSedFestivalPavilionSlots(new THREE.Vector3(-35, 0, 55)),
    },
    {
      id: 'observatory',
      name: 'Observatory',
      icon: '\u{1F52D}',
      worldOffset: new THREE.Vector3(58, 0, 18),
      slots: generateObservatorySlots(new THREE.Vector3(58, 0, 18)),
    },
    {
      id: 'animal-necropolis',
      name: 'Animal Necropolis',
      icon: '\u{1F40F}',
      worldOffset: new THREE.Vector3(15, 0, -75),
      slots: generateAnimalNecropolisSlots(new THREE.Vector3(15, 0, -75)),
    },
    {
      ...
      slots: generatePriestsResidencesSlots(new THREE.Vector3(62, 0, 52)),
    },
    {
      id: 'stone-wharf',
      name: 'Stone Wharf',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(35, 0, -168),
      slots: generateStoneWharfSlots(new THREE.Vector3(35, 0, -168)),
    },
    {
      id: 'temple-of-hathor',
      name: 'Temple of Hathor',
      icon: '\u{1F4AB}',
      worldOffset: new THREE.Vector3(0, 0, -50),
      slots: generateTempleOfHathorSlots(new THREE.Vector3(0, 0, -50)),
    },
    {
      id: 'weaving-mill',
      name: 'Weaving Mill',
      icon: '\u{1F9F5}',
      worldOffset: new THREE.Vector3(88, 0, 35),
      slots: generateWeavingMillSlots(new THREE.Vector3(88, 0, 35)),
    },
    {
      ...
      slots: generateProcessionalWaySlots(new THREE.Vector3(0, 0, -45)),
    },
    {
      id: 'karnak-precinct-wall',
      name: 'Karnak Precinct Wall',
      icon: '\u{1F6AA}',
      worldOffset: new THREE.Vector3(-5, 0, 60),
      slots: generateKarnakPrecinctWallSlots(new THREE.Vector3(-5, 0, 60)),
    },
    {
      id: 'temple-of-ptah',
      name: 'Temple of Ptah',
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(-55, 0, -50),
      slots: generateHatshepsutTerraceSlots(new THREE.Vector3(-55, 0, -50)),
    },
    {
      id: 'grand-harbor',
      name: 'Grand Harbor',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(50, 0, -165),
      slots: generateNileHarborSlots(new THREE.Vector3(50, 0, -165)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F6E1}',
      worldOffset: new THREE.Vector3(0, 0, -120),
      slots: generateGreatEnclosureWallSlots(new THREE.Vector3(0, 0, -120)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1FAA6}',
      worldOffset: new THREE.Vector3(0, 0, -110),
      slots: generateNecropolisDistrictSlots(new THREE.Vector3(0, 0, -110)),
    },
    {
      id: 'temple-of-amun-ra',
      name: 'Temple of Amun-Ra',
      icon: '\u{2600}',
      worldOffset: new THREE.Vector3(0, 0, 48),
      slots: generateTempleOfAmunRaSlots(new THREE.Vector3(0, 0, 48)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(25, 0, -70),
      slots: generateFestivalHallThutmoseSlots(new THREE.Vector3(25, 0, -70)),
    },
    {
      id: 'karnak-hypostyle',
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(0, 0, -150),
      slots: generateThebanAcropolisSlots(new THREE.Vector3(0, 0, -150)),
    },
  ];
