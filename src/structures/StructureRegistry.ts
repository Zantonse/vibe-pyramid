...
export function getStructureRegistry(): Structure[] {
  const registry: Structure[] = [
    ...
    },
    {
      ...
      slots: generateHypostyleHallSlots(new THREE.Vector3(40, 0, 35)),
    },
    {
      id: 'sacred-lake',
      name: 'Sacred Lake',
      icon: '\u{1F30A}',
      worldOffset: new THREE.Vector3(-30, 0, 42),
      slots: generateSacredLakeSlots(new THREE.Vector3(-30, 0, 42)),
    },
    {
      id: 'worker-hovels',
      name: 'Worker Hovels',
      ...
      slots: generateWorkerHovelSlots(new THREE.Vector3(105, 0, 50)),
    },
    {
      id: 'royal-granary',
      name: 'Royal Granary',
      icon: '\u{1F33E}',
      worldOffset: new THREE.Vector3(85, 0, 72),
      slots: generateGranarySlots(new THREE.Vector3(85, 0, 72)),
    },
    {
      id: 'altar',
      name: 'Altar of Offerings',
      icon: '\u{1F525}',
      worldOffset: new THREE.Vector3(20, 0, 40),
      slots: generateAltarSlots(new THREE.Vector3(20, 0, 40)),
    },
    {
      id: 'valley-temple',
      name: 'Valley Temple',
    ...
    },
    {
      ...
      name: 'Small Market',
      icon: '\u{1F3EA}',
      worldOffset: new THREE.Vector3(70, 0, 72),
      slots: generateSmallMarketSlots(new THREE.Vector3(70, 0, 72)),
    },
    {
      id: 'shrine-of-anubis',
    ...
    },
    {
      ...
      icon: '\u{1F528}',
      worldOffset: new THREE.Vector3(70, 0, 38),
      slots: generateCraftsmenQuarterSlots(new THREE.Vector3(70, 0, 38)),
    },
    {
      id: 'colossi',
      name: 'Colossi of Memnon',
      icon: '\u{1F5FF}',
      worldOffset: new THREE.Vector3(15, 0, -40),
      slots: generateColossusSlots(new THREE.Vector3(15, 0, -40)),
    },
    {
      id: 'canopic-shrine',
      name: 'Canopic Shrine',
    ...
    },
    {
      ...
      slots: generatePharaohPalaceSlots(new THREE.Vector3(75, 0, 55)),
    },
    {
      id: 'mud-tenements',
      name: 'Mud Brick Tenements',
      icon: '\u{1F3E0}',
      worldOffset: new THREE.Vector3(110, 0, 55),
      slots: generateMudTenementSlots(new THREE.Vector3(110, 0, 55)),
    },
    {
      id: 'grand-bazaar',
      name: 'Grand Bazaar',
      icon: '\u{1F3AA}',
      worldOffset: new THREE.Vector3(80, 0, 42),
      slots: generateGrandBazaarSlots(new THREE.Vector3(80, 0, 42)),
    },
    {
      id: 'noble-villa',
      name: 'Noble Villa',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(100, 0, 60),
      slots: generateNobleVillaSlots(new THREE.Vector3(100, 0, 60)),
    },
    {
      id: 'government-hall',
      name: 'Government Hall',
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(85, 0, 50),
      slots: generateGovernmentHallSlots(new THREE.Vector3(85, 0, 50)),
    },
    {
      id: 'royal-treasury',
      name: 'Royal Treasury',
      icon: '\u{1F48E}',
      worldOffset: new THREE.Vector3(90, 0, 55),
      slots: generateRoyalTreasurySlots(new THREE.Vector3(90, 0, 55)),
    },
    {
      id: 'great-quarry',
      name: 'The Great Quarry',
      icon: '\u{26CF}',
      worldOffset: new THREE.Vector3(110, 0, 78),
      slots: generateGreatQuarrySlots(new THREE.Vector3(110, 0, 78)),
    },
    {
      id: 'irrigation-canal',
      name: 'Irrigation Canal',
      icon: '\u{1F6BF}',
      worldOffset: new THREE.Vector3(40, 0, 70),
      slots: generateIrrigationCanalSlots(new THREE.Vector3(40, 0, 70)),
    },
    {
      id: 'cliff-temple',
      name: 'Cliff Temple',
      icon: '\u{1F3D4}',
      worldOffset: new THREE.Vector3(45, 0, -30),
      slots: generateCliffTempleSlots(new THREE.Vector3(45, 0, -30)),
    },
    {
      id: 'marketplace',
      name: 'Marketplace',
      icon: '\u{1F3EA}',
      worldOffset: new THREE.Vector3(95, 0, 75),
      slots: generateMarketplaceSlots(new THREE.Vector3(95, 0, 75)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F5FC}',
      worldOffset: new THREE.Vector3(60, 0, 55),
      slots: generateLighthouseSlots(new THREE.Vector3(60, 0, 55)),
    },
    {
      id: 'eternal-city',
      name: 'Eternal City',
    ...
    },
    {
      ...
      slots: generateEmbalmersWorkshopSlots(new THREE.Vector3(65, 0, 35)),
    },
    {
      id: 'scribes-academy',
      name: "Scribes' Academy",
      icon: '\u{1F4DC}',
      worldOffset: new THREE.Vector3(95, 0, 45),
      slots: generateScribesAcademySlots(new THREE.Vector3(95, 0, 45)),
    },
    {
      id: 'nilometer',
      name: 'Nilometer',
      icon: '\u{1F4CF}',
      worldOffset: new THREE.Vector3(30, 0, 60),
      slots: generateNilometerSlots(new THREE.Vector3(30, 0, 60)),
    },
    {
      id: 'chariot-stable',
      name: 'Chariot Stable',
      icon: '\u{1F6F4}',
      worldOffset: new THREE.Vector3(95, 0, 65),
      slots: generateChariotStableSlots(new THREE.Vector3(95, 0, 65)),
    },
    {
      id: 'brewery-bakery',
      name: 'Brewery & Bakery',
      icon: '\u{1F37A}',
      worldOffset: new THREE.Vector3(75, 0, 35),
      slots: generateBreweryBakerySlots(new THREE.Vector3(75, 0, 35)),
    },
    {
      id: 'military-garrison',
      name: 'Military Garrison',
      icon: '\u{1F6E1}',
      worldOffset: new THREE.Vector3(100, 0, 70),
      slots: generateGuardBarracksSlots(new THREE.Vector3(100, 0, 70)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(35, 0, 45),
      slots: generateSedFestivalPavilionSlots(new THREE.Vector3(35, 0, 45)),
    },
    {
      id: 'observatory',
      name: 'Observatory',
      ...
      slots: generateObservatorySlots(new THREE.Vector3(55, 0, 20)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F6D5}',
      worldOffset: new THREE.Vector3(65, 0, 48),
      slots: generatePriestsResidencesSlots(new THREE.Vector3(65, 0, 48)),
    },
    {
      id: 'stone-wharf',
      name: 'Stone Wharf',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(60, 0, 75),
      slots: generateStoneWharfSlots(new THREE.Vector3(60, 0, 75)),
    },
    {
      id: 'temple-of-hathor',
    ...
    },
    {
      ...
      name: 'Weaving Mill',
      icon: '\u{1F9F5}',
      worldOffset: new THREE.Vector3(85, 0, 38),
      slots: generateWeavingMillSlots(new THREE.Vector3(85, 0, 38)),
    },
    {
    ...
    },
    {
      ...
      slots: generateKarnakPrecinctWallSlots(new THREE.Vector3(0, 0, 55)),
    },
    {
      id: 'temple-of-ptah',
      name: 'Temple of Ptah',
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(-45, 0, -30),
      slots: generateHatshepsutTerraceSlots(new THREE.Vector3(-45, 0, -30)),
    },
    {
      id: 'grand-harbor',
      name: 'Grand Harbor',
      icon: '\u{2693}',
      worldOffset: new THREE.Vector3(80, 0, 78),
      slots: generateNileHarborSlots(new THREE.Vector3(80, 0, 78)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{2600}',
      worldOffset: new THREE.Vector3(0, 0, 50),
      slots: generateTempleOfAmunRaSlots(new THREE.Vector3(0, 0, 50)),
    },
    {
    ...
    },
    {
      ...
      icon: '\u{1F3DB}',
      worldOffset: new THREE.Vector3(45, 0, 40),
      slots: generateKarnakHypostyleSlots(new THREE.Vector3(45, 0, 40)),
    },
    {
